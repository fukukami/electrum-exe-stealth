...
def run_network_dialog( network, parent ):
    ...
    add_help_button(host_box, 'The name, port number and protocol of your Electrum server, separated by a colon. Example: "server.electrum-exe.org:50012:s". Some servers allow you to connect through http (port 80) or https (port 443)')
    host_box.show()
