...
from electrum_exe.util import print_error, print_msg, parse_url
...
from electrum_exe import WalletStorage, Wallet
...
from electrum_exe.plugins import init_plugins
...
class ElectrumGui:
    ...
    def build_tray_menu(self):
        ...
        m.addSeparator()
        m.addAction(_("Exit Electrum-EXE Stealth"), self.close)
    ...
    def set_url(self, url):
        ...
        if request_url:
            try:
                from electrum_exe import paymentrequest
            except:
    ...
    def main(self, url):
        ...
        self.tray.setToolTip('Electrum-EXE Stealth')
