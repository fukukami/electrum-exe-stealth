...
from electrum_exe.i18n import _, set_language
from electrum_exe.util import print_error, print_msg
...
from electrum_exe.wallet import format_satoshis
...
from electrum_exe import ELECTRUM_VERSION
import re
...
class ElectrumWindow(QMainWindow):
    ...
    def __init__(self, config, network, gui_object):
        ...
        self.setWindowIcon(QIcon(":icons/electrum-exe.png"))
        self.init_menubar()
    ...
    def load_wallet(self, wallet):
        import electrum_exe as electrum
        self.wallet = wallet
    ...
    def init_menubar(self):
        ...
        help_menu.addAction(_("&Official website"), lambda: webbrowser.open("http://electrum-exe.org/stealth/"))
        help_menu.addSeparator()
        help_menu.addAction(_("&Documentation"), lambda: webbrowser.open("http://electrum-exe.org/stealth/documentation.html")).setShortcut(QKeySequence.HelpContents)
    ...
    def show_report_bug(self):
        QMessageBox.information(self, "Electrum-EXE Stealth - " + _("Reporting Bugs"),
            _("Please report any bugs as issues on github:")+" <a href=\"https://github.com/fukukami/electrum-exe-stealth/issues\">https://github.com/fukukami/electrum-exe-stealth/issues</a>")
    ...
    def base_unit(self):
        ...
        return "EXE" if self.decimal_point == 8 else "mEXE"
    ...
    def create_send_tab(self):
        ...
        grid.addWidget(HelpButton(_('Recipient of the funds.') + '\n\n' + _('You may enter a Execoin address, a label from your list of contacts (a list of completions will be proposed), or an alias (email-like address that forwards to a Execoin address)')), 1, 4)
        ...
        grid.addWidget(HelpButton(
                _('Execoin transactions are in general not free. A transaction fee is paid by the sender of the funds.') + '\n\n'\
    ...
    def create_receive_menu(self, position):
        ...
        if not multi_select:
            ...
            menu.addAction(_("QR code"), lambda: self.show_qrcode("execoin:" + addr, _("Address")) )
            menu.addAction(_("Edit label"), lambda: self.edit_label(True))
    ...
    def new_account_dialog(self, password):
        ...
        e = QLineEdit()
        vbox.addWidget(e)
        msg = _("Note: Newly created accounts are 'pending' until they receive execoins.") + " " \
    ...
    def export_privkeys_dialog(self, password):
        ...
        defaultname = 'electrum-exe-private-keys.csv'
    ...
    def do_export_labels(self):
        ...
        try:
            fileName = self.getSaveFileName(_("Select file to save your labels"), 'electrum-exe_labels.dat', "*.dat")
            if fileName:
                with open(fileName, 'w+') as f:
                    json.dump(labels, f)
    ...
    def export_history_dialog(self):
        ...
        defaultname = os.path.expanduser('~/electrum-exe-history.csv')
    ...
    def settings_dialog(self):
        ...
        from electrum_exe.i18n import languages
        ...
        if self.base_unit() != unit_result:
            self.decimal_point = 8 if unit_result == 'EXE' else 5
    ...
    def plugins_dialog(self):
        from electrum_exe.plugins import plugins
