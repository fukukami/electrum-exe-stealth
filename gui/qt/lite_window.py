...
class MiniWindow(QDialog):
    ...
    def __init__(self, actuator, expand_callback, config):
        ...
        self.address_input.setPlaceholderText(_("Enter a Execoin address or contact"))
    ...
    def the_website(self):
        webbrowser.open("http://electrum-exe.org")
...
class ReceivePopup(QDialog):
    ...
    def setup(self, address):
        label = QLabel(_("Copied your Execoin address to the clipboard!"))
        ...
        self.setWindowTitle("Electrum - " + _("Receive Execoin payment"))
